...
function createMoviePreview(movie) {
   ...
   const detailsButton = elementFactory(
      'button',
      {
         'data-id': `${id}`,
         class: 'btn btn-info',
   ...
   const cardFooterDiv = elementFactory(
      'div',
      {
         class: 'card-footer',
      },
   ...
   const titleElement = elementFactory(
      'h4',
      {
         class: 'card-title',
      },
   ...
   const cardBodyDiv = elementFactory(
      'div',
      {
         class: 'card-body',
      },
   ...
   const movieCardElement = elementFactory(
      'li',
      {
         class: 'card mb-4',
      },
