...
const host = "http://localhost:3000/Exam%20Preparation/01.Sole-Mates"; // Application host (NOT service host - that can be anything)
const interval = 600;
const DEBUG = true;
const slowMo = 500;
...
describe("E2E tests", function () {
  ...
  describe("Home Page [ 10 Points ]", () => {
    it.only("Show home page [ 2.5 Points ]", async () => {
      await page.goto(host);
      await page.waitForTimeout(interval);
